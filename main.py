...
if __name__ == '__main__':
    ...
    mik.new_estimate("философия", 18, "test")
    mik.new_estimate("философия", 74, "test")
    mik.new_estimate("биология", 39, "test")
    mik.new_estimate("биология", 89, "test")
    print(mik)